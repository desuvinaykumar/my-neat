...
(function(x) {
    ...
    function me(a) {
        if (C(a))
            u(a.objectMaxDepth) && (Ic.objectMaxDepth = Sb(a.objectMaxDepth) ? a.objectMaxDepth : NaN);
        else
            return Ic
    }
    function Sb(a) {
        ...
        for (var c = a.$$hashKey, e = 0, f = b.length; e < f; ++e) {
            ...
            if (C(g) || D(g))
                for (var h = Object.keys(g), k = 0, l = h.length; k < l; k++) {
                    var m = h[k]
                      , n = g[m];
                    d && C(n) ? ga(n) ? a[m] = new Date(n.valueOf()) : Xa(n) ? a[m] = new RegExp(n) : n.nodeName ? a[m] = n.cloneNode(!0) : Ub(n) ? a[m] = n.clone() : (C(a[m]) || (a[m] = H(n) ? [] : {}),
                    Tb(a[m], [n], !0)) : a[m] = n
                }
        }
    ...
    function cb(a, b) {
        if (!w(a))
            return ba(b) || (b = b ? 2 : null),
            JSON.stringify(a, Nc, b)
    }
    function Oc(a) {
    ...
    function Sc(a, b, d) {
        ...
        x && e.test(x.name) && (d.debugInfoEnabled = !0,
    ...
    function ze() {
        ...
        if (!Uc) {
            var b = rb();
            (na = w(b) ? x.jQuery : b ? x[b] : void 0) && na.fn.on ? (B = na,
            S(na.fn, {
                scope: Na.scope,
            ...
            q(a, function(a) {
                ...
                if (!m.get(a)) {
                    ...
                    try {
                        ...
                        d(c._invokeQueue),
                        d(c._configBlocks)) : D(a) ? b.push(p.invoke(a)) : H(a) ? b.push(p.invoke(a)) : sb(a, "module")
                    } catch (e) {
        ...
        this.$get = ["$window", "$location", "$rootScope", function(b, d, c) {
            ...
            function f(a) {
                if (a) {
                    ...
                    c = g.yOffset;
                    D(c) ? c = c() : Ub(c) ? (c = c[0],
                    c = "fixed" !== b.getComputedStyle(c).position ? 0 : c.getBoundingClientRect().bottom) : ba(c) || (c = 0);
    ...
    function pg(a, b, d, c) {
        ...
        k.url = function(b, d, e) {
            ...
            if (b) {
                ...
                N = b;
                M = e;
                !c.history || h && f ? (h || (Oa = b),
                d ? l.replace(b) : h ? (d = l,
                e = b.indexOf("#"),
                e = -1 === e ? "" : b.substr(e),
                d.hash = e) : l.href = b,
                l.href !== b && (Oa = b)) : (m[d ? "replaceState" : "pushState"](e, "", b),
                g());
                Oa && (Oa = b);
                return k
            }
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$sce", "$animate", "$$sanitizeUri", function(a, b, c, e, n, E, G, y, O, X) {
            ...
            function Ma(a, b, c, d, e, f) {
                function g(a, c, d, e) {
                    ...
                    for (n = h.length; m < n; )
                        ...
                        f = h[m++],
                        c ? (c.scope ? (l = a.$new(),
                        ca.$$addScopeInfo(B(k), l)) : l = a,
                        p = c.transcludeOnThisElement ? ja(a, c.transclude, e) : !c.templateOnThisElement && e ? e : !e && b ? ja(a, b) : null,
                        c(f, l, k, d, p)) : f && f(a, k.childNodes, void 0, e)
                }
            ...
            function W(a, b, d, e, f, g, h, k, l) {
                ...
                function n(a, e, f, g, l) {
                    ...
                    E && (ca.$$addScopeInfo(P, v, !0, !(I && (I === E || I === E.$$originalDirective))),
                    ...
                    for (y = h.length; p < y; p++)
                        t = h[p],
                        ra(t, t.isolateScope ? v : e, P, g, t.require && U(t.directiveName, t.require, P, O), N);
                    var R = e;
                ...
                for (var p = -Number.MAX_VALUE, K = l.newScopeDirective, G = l.controllerDirectives, E = l.newIsolateScopeDirective, I = l.templateDirective, t = l.nonTlbTranscludeDirective, J = !1, O = !1, X = l.hasElementTranscludeDirective, v = d.$$element = B(b), y, P, N, A = e, R, u = !1, La = !1, x, z = 0, F = a.length; z < F; z++) {
                    ...
                    if (p > y.priority)
                        break;
                    if (x = y.scope)
                        y.templateUrl || (C(x) ? ($("new/isolated scope", E || K, y, v),
                        E = y) : $("new/isolated scope", E, y, v)),
                        K = K || y;
                    P = y.name;
                    ...
                    !y.templateUrl && y.controller && (G = G || V(),
                    $("'" + P + "' controller", G[P], y, v),
                    G[P] = y);
                    if (x = y.transclude)
                        if (J = !0,
                        y.$$tlb || ($("transclusion", t, y, v),
                        t = y),
                        "element" === x)
                            X = !0,
                            p = y.priority,
                    ...
                    y.terminal && (n.terminal = !0,
                    p = Math.max(p, y.priority))
                }
                n.scope = K && !0 === K.scope;
                    ...
                    for (var n = 0, p = h.length; n < p; n++)
                        ...
                        (w(g) || g > c.priority) && -1 !== c.restrict.indexOf(e)) {
                            ...
                            if (!c.$$bindings) {
                                ...
                                C(K.scope) && (!0 === K.bindToController ? (t.bindToController = d(K.scope, r, !0),
                                t.isolateScope = {}) : t.isolateScope = d(K.scope, r, !1));
            ...
            function na(a, c, d, e, f) {
                function g(b, c, e) {
                    D(d.$onChanges) && !Xb(c, e) && (ia || (a.$$postDigest(P),
                    ia = []),
                    m || (m = {},
                    ia.push(h)),
    ...
    function wf() {
        ...
        this.$get = ["$injector", "$window", function(d, c) {
            ...
            return function(f, g, h, k) {
                ...
                if (h)
                    return h = (H(f) ? f[f.length - 1] : f).prototype,
    ...
    function Df() {
        ...
        this.$get = ["$browser", "$httpBackend", "$$cookieReader", "$cacheFactory", "$rootScope", "$q", "$injector", "$sce", function(c, e, f, g, h, k, l, m) {
            ...
            function p(c, d) {
                ...
                O && (X = O.get(R),
                u(X) ? X && D(X.then) ? X.then(K, K) : H(X) ? p(X[1], X[0], pa(X[2]), X[3]) : p(X, 200, {}, "OK") : O.put(R, y));
                w(X) && ((X = yd(c.url) ? f()[c.xsrfCookieName || a.xsrfCookieName] : void 0) && (P[c.xsrfHeaderName || a.xsrfHeaderName] = X),
                e(c.method, R, d, l, P, c.timeout, c.withCredentials, c.responseType, g(c.eventHandlers), g(c.uploadEventHandlers)));
                return y
            }
            function r(a, b) {
    ...
    function Cf() {
        this.$get = ["$rootScope", "$window", "$q", "$$q", "$browser", function(a, b, d, c, e) {
            ...
            var g = {};
            f.cancel = function(a) {
                return a && a.$$intervalId in g ? (g[a.$$intervalId].promise.catch(z),
            ...
            f.on("click", function(a) {
                ...
                if (e && !a.ctrlKey && !a.metaKey && !a.shiftKey && 2 !== a.which && 2 !== a.button) {
                    ...
                    if (!F(e) || !w(h.attr(e))) {
                        ...
                        J.test(e) || !e || h.attr("target") || a.isDefaultPrevented() || !l.$$parseLinkUrl(e, k) || (a.preventDefault(),
    ...
    function U(a, b) {
        ...
        case s.ObjectExpression:
            ...
            q(a.properties, function(a) {
                ...
                a.computed && (U(a.key, b),
                a.key.constant || c.push.apply(c, a.key.toWatch))
            });
            a.constant = d;
            a.toWatch = c;
            break;
    ...
    function Lf() {
        ...
        this.$get = ["$filter", function(e) {
            function f(a, b, c) {
                return null == a || null == b ? a === b : "object" !== typeof a || (a = vc(a),
            ...
            return function(b, c) {
                ...
                case "string":
                    ...
                    d.constant ? d.$$watchDelegate = l : f ? (d.oneTime = !0,
                    d.$$watchDelegate = h) : d.inputs && (d.$$watchDelegate = g),
                    a[k] = d),
                    m(d, c);
                case "function":
                    return m(b, c);
    ...
    function Jd(a, b, d) {
        ...
        function h(b) {
            !d || b.pending || 2 !== b.status || b.pur || (0 === s && 0 === A.length && a(g),
            A.push(b));
    ...
    function Mf() {
        ...
        this.$get = ["$exceptionHandler", "$parse", "$browser", function(f, g, h) {
            ...
            function l(a) {
                9 === za && (a.$$childHead && l(a.$$childHead),
            ...
            m.prototype = {
                ...
                $digest: function() {
                    ...
                    n("$digest");
                    h.$$checkUrlChange();
                    this === M && null !== e && (h.defer.cancel(e),
                    v());
                    c = null;
                    do {
                        r = !1;
                        ...
                        a: do {
                            if (p = q.$$watchers)
                                for (p.$$digestWatchIndex = p.length; p.$$digestWatchIndex--; )
                                    try {
                                        if (a = p[p.$$digestWatchIndex])
                                            if (m = a.get,
                                            (g = m(q)) !== (k = a.last) && !(a.eq ? sa(g, k) : da(g) && da(k)))
                                                r = !0,
                                                c = a,
        ...
        this.$get = ["$exceptionHandler", "$templateCache", "$http", "$q", "$sce", function(b, d, c, e, f) {
            function g(h, k) {
                ...
                return c.get(h, S({
                    ...
                    k || (a = Dg("tpload", h, a.status, a.statusText),
                    b(a));
                    return e.reject(a)
                })
            }
    ...
    function Vf() {
        this.$get = ["$rootScope", "$browser", "$q", "$$q", "$exceptionHandler", function(a, b, d, c, e) {
            ...
            var g = {};
            f.cancel = function(a) {
                return a && a.$$timeoutId in g ? (g[a.$$timeoutId].promise.catch(z),
    ...
    function Rd(a) {
        ...
        function c(a, b) {
            ...
            if (d === k) {
                ...
                l = l.toLowerCase()) : "object" === d && (C(k) && (k = a.index),
                C(l) && (l = b.index));
                k !== l && (c = k < l ? -1 : 1)
            } else
                c = d < k ? -1 : 1;
    ...
    var Sg = /^\/(.+)\/([a-z]*)$/, ua = Object.prototype.hasOwnProperty, Ic = {
        objectMaxDepth: 5
    }, Q = function(a) {
        ...
        readString: function(a) {
            ...
            for (var d = "", c = a, e = !1; this.index < this.text.length; ) {
                ...
                if (e)
                    ...
                    this.index += 4,
                    d += String.fromCharCode(parseInt(e, 16))) : d += $g[f] || f,
                    e = !1;
                else if ("\\" === f)
                    e = !0;
                else {
    ...
    s.prototype = {
        ...
        primary: function() {
            ...
            this.consume(")")) : this.expect("[") ? a = this.arrayDeclaration() : this.expect("{") ? a = this.object() : this.selfReferential.hasOwnProperty(this.peek().text) ? a = ra(this.selfReferential[this.consume().text]) : this.options.literals.hasOwnProperty(this.peek().text) ? a = {
                type: s.Literal,
      ...
      , mf = ["$compile", function(a) {
        return {
            ...
            link: function(b, d, c, e) {
                ...
                a(dd(e.template, x.document).childNodes)(b, function(a) {
                    d.append(a)
                }, {
    ...
    var lf = function() {
            ...
            link: {
                ...
                post: function(d, h, k, l) {
                    ...
                    function p() {
                        ...
                        (z.trackBy || v ? sa(a, b) : a === b) || (s.$setViewValue(b),
                        s.$render()))
                    }
                    var r = l[0]
                      , s = l[1]
                    ...
                    z.trackBy && d.$watchCollection(function() {
                        ...
                        c ? (h[0].value !== c.selectValue && (r.removeUnknownOption(),
                        r.unselectEmptyOption(),
                        h[0].value = c.selectValue,
                        c.element.selected = !0),
                        c.element.setAttribute("selected", "selected")) : x ? r.selectEmptyOption() : r.unknownOption.parent().length ? r.updateUnknownOption(a) : r.renderUnknownOption(a)
                    }
                    ,
                    r.readValue = function() {
                        var a = A.selectValueMap[h.val()];
                        return a && !a.disabled ? (r.unselectEmptyOption(),
                    ...
                    x && (r.emptyOption.remove(),
                    a(r.emptyOption)(d),
                    8 === r.emptyOption[0].nodeType ? (r.hasEmptyOption = !1,
                    r.registerOption = function(a, b) {
                        "" === b.val() && (r.hasEmptyOption = !0,
                        r.emptyOption = b,
                    ...
                    a.$watchCollection(n, function(f) {
                        ...
                        for (g = 0; g < B; g++)
                            ...
                            E.scope) {
                                ...
                                do
                                    t = t.nextSibling;
                                while (t && t.$$NG_REMOVED);E.clone[0] !== t && b.move(tb(E.clone), null, r);
      ...
      , jh = ["$element", "$scope", function(a, b) {
        ...
        e.writeValue = function(b) {
            ...
            Ta(B(a[0].options[a[0].selectedIndex]), !0)) : null == b && e.emptyOption ? (e.removeUnknownOption(),
        ...
        e.registerOption = function(a, b, f, g, h) {
            if (f.$attr.ngValue) {
                ...
                f.$observe("value", function(a) {
                    ...
                    u(s) && (e.removeOption(q),
                    delete e.selectValueMap[s],
                    d = !0);
                    s = Pa(a);
                    q = a;
                ...
                pre: function(a, b, d, c) {
                    ...
                    if (f) {
                        ...
                        d.multiple) {
                            ...
                            var g, h = NaN;
                            a.$watch(function() {
                                h !== f.$viewValue || sa(g, f.$viewValue) || (g = pa(f.$viewValue),
                                f.$render());
                                h = f.$viewValue
                            });
    ...
    x.angular.bootstrap ? x.console && console.log("WARNING: Tried to load angular more than once.") : (ze(),
    Ce(ea),
